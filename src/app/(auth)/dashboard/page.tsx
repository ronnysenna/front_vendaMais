    ...
    <div className="container-fluid py-4">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-4 p-3 bg-white rounded-4 shadow-sm">
        <div>
          ...
          <p className="text-muted mb-0">Visualize suas métricas em tempo real</p>
        </div>
          ...
          <div className="card h-100 card-status-primary">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <h6 className="card-title text-primary mb-0 fw-semibold">Total de Produtos</h6>
              </div>
              <h3 className="mb-0 gradient-number display-6">0</h3>
              <small className="text-muted fw-medium">Produtos cadastrados</small>
            </div>
          </div>
        </div>
          ...
          <div className="card h-100 card-status-success">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <h6 className="card-title text-success mb-0 fw-semibold">Vendas do Mês</h6>
              </div>
              <h3 className="mb-0 gradient-number display-6">0</h3>
          ...
          <div className="card h-100 card-status-info">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <h6 className="card-title text-info mb-0 fw-semibold">QR Codes</h6>
              </div>
              <h3 className="mb-0 gradient-number display-6">0</h3>
          ...
          <div className="card h-100 card-status-warning">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <h6 className="card-title text-warning mb-0 fw-semibold">Clientes</h6>
              </div>
              <h3 className="mb-0 gradient-number display-6">0</h3>
              <small className="text-muted fw-medium">Clientes cadastrados</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row g-4">
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h5 className="card-title mb-0 fw-bold">Vendas nos Últimos Meses</h5>
              ...
              <div className="chart-placeholder">
                <div className="text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-3 text-primary"><path d="M3 3v18h18" /><path d="m19 9-5 5-4-4-3 3" /></svg>
                  <p className="text-muted mb-0 fw-medium">Gráfico de vendas será implementado aqui</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-12 col-lg-4">
          <div className="card">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h5 className="card-title mb-0 fw-bold">Produtos Mais Vendidos</h5>
                <select className="select-modern">
                  <option>Top 5</option>
              ...
              <div className="chart-placeholder">
                <div className="text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-3 text-primary"><path d="M3 3v18h18" /><path d="m3 15 4-4 4 4 4-4 4 4" /></svg>
                  <p className="text-muted mb-0 fw-medium">Gráfico de produtos será implementado aqui</p>
                </div>
              </div>
            </div>
          </div>
